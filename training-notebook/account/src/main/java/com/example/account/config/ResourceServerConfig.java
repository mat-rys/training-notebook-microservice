...
public class ResourceServerConfig  {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                .addFilterBefore(gatewayHeaderFilter(), UsernamePasswordAuthenticationFilter.class) // Dodanie filtra przed autoryzacją
                .authorizeRequests(authorizeRequests ->
                        authorizeRequests
//                                .requestMatchers(HttpMethod.POST,"/account/register").permitAll()
//                                .requestMatchers("/account/users").permitAll()
//                                .requestMatchers("/account/admin/user/sessions").permitAll()
