...
public class ProductMealsServiceImpl implements ProductMealsService {
    ...
    @Override
    @Transactional // Upewniamy się, że operacje są wykonane w jednej transakcji
    public void saveAll(List<ProductsMeals> productsMeals) {
        productMealsRepository.saveAll(productsMeals);
    }
