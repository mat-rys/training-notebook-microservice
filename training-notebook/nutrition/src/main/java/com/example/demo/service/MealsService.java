...
public interface MealsService {
    ...
    List<DailyPercentageNutritionDTO> getMealsNutritionByDateRange(String userId, Date startDate, Date endDate);

    List<MealTimeDTO> getMealTimesByUserIdAndDateRange(String userId, Date startDate, Date endDate);
}
